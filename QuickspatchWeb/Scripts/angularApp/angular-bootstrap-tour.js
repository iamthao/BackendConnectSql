            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    var step = {
                        ...
                        events = 'onShow onShown onHide onHidden onNext onPrev onPause onResume onEnd'.split(' '),
                    ...
                    element.ready(function () {
                        TourHelpers.safeApply(scope, function () {
                            //var func = $parse(attrs[TourHelpers.getAttrName('elemReady')]);
                            //func(scope);
                            if (document.getElementById("chk-tour-do-not-show-again") != null) {
                                alert(document.getElementById("chk-tour-do-not-show-again").checked);
                            }
                        });
                    });
                    ...
                    function setRedirect(direction, path, targetName) {
                        ...
                        step[direction] = function (tour) {
                            ...
                            if (document.getElementById("chk-tour-do-not-show-again").checked == true) {
                                $.ajax({
                                    method: "POST",
                                    url: "/home/showisquicktour",
                                    data: { isQuickTour: false }
                                })
                              .done(function () {
                              });
                            } else {
