'use strict';
app.directive('timeLocation', ['$q', '$http', '$timeout', function ($q, $http, $timeout) {
    return {
        restrict: "E",
        scope: true,
            ...
            function setValue(ele) {
                ...
                $timeout(function () {
                    $scope.$apply(function () {
                        if ($attrs["bindObj"] == 'Location') {
                            if ($attrs["bindVal"] == 'OpenHour') {
                                //console.log('OpenHour',bind)
                                $scope.$parent.Location[$attrs["bindVal"]] = bind;
                            }
                            if ($attrs["bindVal"] == 'CloseHour') {
                               // console.log('CloseHour', bind)
                                $scope.$parent.Location[$attrs["bindVal"]] = bind;
                            }
                        }                       
                    });
